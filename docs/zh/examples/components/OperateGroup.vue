  ...
  <div class="operate-wrap">
    <div class="operate">
      <div class="operate-item">
        <button class="demo-btn" @click="goScrollOffset">滚动到(px)</button>
        <input class="demo-input" type="number" v-model="scrollToOffset" />
      </div>
      <div class="operate-item">
        <button class="demo-btn" @click="goScrollIndex">滚动到(index)</button>
        <input class="demo-input" type="number" v-model="scrollToIndex" />
      </div>
      <div class="operate-item">
        <button class="demo-btn" @click="goScrollIntoView">显示(index)</button>
        <input class="demo-input" type="number" v-model="scrollIntoViewIndex" />
        <button class="demo-btn" @click="goScrollIntoViewPrev">上一个</button>
        <button class="demo-btn" @click="goScrollIntoViewNext">下一个</button>
      </div>
      <div class="operate-item">
        <button class="demo-btn" @click="goScrollTop">到顶部</button>
      </div>
      <div class="operate-item">
        <button class="demo-btn" @click="goScrollBottom">到底部</button>
      </div>
      <div class="operate-item">
        <button class="demo-btn" @click="toggleShow">显示/隐藏</button>
      </div>
      <!-- <div class="operate-item">
